...
=============
1. Introduction
Thank you for downloading the "Water-Woes" water pipe simulation program.
2. Starting
To run the program, use your IDE of choice (such as BlueJ or Intellij) and use the tools to create a new WWWindow.
3. Operation
3.1 The UI
On the left two-thirds of the screen sits an 8x8 grid for you to craft your network on.
...
Sinks, the round orange pipes, do not produce or transfer water and are intended as end points for the pipe network.
